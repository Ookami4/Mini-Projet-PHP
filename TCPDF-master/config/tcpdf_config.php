 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Redouan');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Redouan');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'RedOne Store');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by El Khanoussi Redouan - Redonestore.com");
